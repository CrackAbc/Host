...
TOKEN = os.environ.get('TELEGRAM_BOT_TOKEN', '8767392586:AAG17S20HMFuIjg7HxOVrMQtr46HEItkR1M')
OWNER_ID = int(os.environ.get('OWNER_ID', 8735997519))
ADMIN_ID = int(os.environ.get('ADMIN_ID', 8735997519))
YOUR_USERNAME = os.environ.get('YOUR_USERNAME', '@SomsPvtt')
UPDATE_CHANNEL = os.environ.get('UPDATE_CHANNEL', 'https://t.me/SomsPvtt')
